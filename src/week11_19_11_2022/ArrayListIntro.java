...
public class ArrayListIntro {
    public static void main(String[] args) {
        ...
        numbers1.remove(1);// 3
        System.out.println(numbers1);
        Integer b=4; //  Integer.valueOf(4)
        numbers1.remove(b); // it will remove your element or  numbers1.remove(Integer.valueOf(4))
        System.out.println(numbers1);
        numbers1.remove(new Integer(5)); // or numbers1.remove((Integer)5);
        System.out.println(numbers1);
 ...
 */  // each
        ...
        number3.remove((Integer) 3);
        System.out.println(number3);

        //ArrayList<String> names4 = {"James", "Jack", "John"}; gives error
